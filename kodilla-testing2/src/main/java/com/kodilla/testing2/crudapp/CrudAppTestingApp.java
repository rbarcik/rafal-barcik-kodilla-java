...
public class CrudAppTestingApp {
    ...
    public static final String XPACH_TEXTAREA = "//html/body/main/section/form/fieldset[2]/textarea";
    ...
    public static void main(String[] args) {
        ...
        driver.get("https://rbarcik.github.io/");

        WebElement searchField = driver.findElement(By.xpath(XPATH_INPUT));
        searchField.sendKeys("New robotic task");

        WebElement textareaField = driver.findElement(By.xpath(XPACH_TEXTAREA));
