...
public class CrudAppTestSuite {
    private static final String BASE_URL = "https://rbarcik.github.io/";
    ...
    private boolean checkTaskExistInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("barcik.r@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("lomtjjz1");
